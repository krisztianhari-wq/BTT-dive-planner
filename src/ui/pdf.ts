...
async function saveBlob(blob: Blob, filename: string): Promise<void> {
  if (isMobileTauri()) {
    // iOS: system share sheet (AirDrop, Files, Mail, …); Android's webview has no Web Share,
    // so it falls through to the native "save as" dialog below (SAF document picker).
