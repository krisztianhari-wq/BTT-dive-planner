...
const hu = {
  ...
  tabSetup: 'Beállítás',
  tabPlan: 'Terv',
  tabTimeline: 'Menetrend',
  tabGasCheck: 'Gázellenőrzés',
  tabTeamGas: 'Csapatgáz',
  tabKit: 'Felszerelés',
  tabDeco: 'Dekó',
  ...
  showPlan: 'Terv megjelenítése',
  matchTeamGas: 'Csapatgáz egyeztetése',
  exportChecklist: 'Felszereléslista PDF-be',
  sharePdf: 'PDF megosztása',
  saveFiles: 'Mentés fájlba',
  pdfDoc: 'PDF dokumentum · A4',
  toastSaved: 'Mentve',
  toastShared: 'PDF megosztva',
  toastPrint: 'Nyomtatásra küldve',
  exportNeedsPlan: 'Előbb készíts érvényes tervet.',
  profile: 'Profil',
  profileAxes: (u: Units) => `mélység ${u.d} · idő perc`,
  leaveAt: (rt: number) => `indulás a ${rt}. percben`,
  enough: 'Elég',
  shortBy: (v: string) => `${v} hiányzik`,
  teamTurnsAt: 'A csapat fordul',
  limitedBy: (n: string) => `${n} korlátoz`,
  teamSizeLabel: (n: number) => `Csapat · létszám ${n}`,
  diverSummary: (gas: string, p: string) => `${gas} · indulás ${p}`,
  algorithmRow: 'Bühlmann ZH-L16C + gradient factor',
  minUnit: 'perc',
  techFeasible: (std: string) => `A ${std} szabályai szerint megmerülhető.`,
  techNotFeasible: (std: string) => `A ${std} szabályai szerint nem merülhető.`,
  ...
  disclaimer: 'Minden merülésnek megvan a veszélye, az applikáció támogat, de nem helyettesíti a gondolkodást és a tervezés felelősségét sem veszi át tőled. Csak olyat merülj amit a képzettséged megenged, ha nem érzed, ne merülj!',
  dive: 'Merülés',
  ...
  decoTotal: 'felszállás + dekó (perc)',
  ...
  printDisclaimer: 'Minden merülésnek megvan a veszélye, az applikáció támogat, de nem helyettesíti a gondolkodást és a tervezés felelősségét sem veszi át tőled. Csak olyat merülj amit a képzettséged megenged, ha nem érzed, ne merülj!',
  itinerary: 'Itiner',
  itTime: 'Perc',
...
const en: Dict = {
  ...
  exportTitle: 'Export',
  showPlan: 'Show plan',
  matchTeamGas: 'Match team gas',
  exportChecklist: 'Export checklist as PDF',
  sharePdf: 'Share PDF',
  saveFiles: 'Save to Files',
  pdfDoc: 'PDF Document · A4',
  toastSaved: 'Saved',
  toastShared: 'PDF shared',
  toastPrint: 'Sent to printer',
  exportNeedsPlan: 'Make a valid plan first.',
  profile: 'Profile',
  profileAxes: (u) => `depth ${u.d} · time min`,
  leaveAt: (rt) => `leave at runtime ${rt}`,
  enough: 'Enough',
  shortBy: (v) => `${v} short`,
  teamTurnsAt: 'Team turns at',
  limitedBy: (n) => `Limited by ${n}`,
  teamSizeLabel: (n) => `Team · size ${n}`,
  diverSummary: (gas, p) => `${gas} · start ${p}`,
  algorithmRow: 'Bühlmann ZH-L16C + gradient factors',
  minUnit: 'min',
  techFeasible: (std) => `Diveable under ${std} rules.`,
  techNotFeasible: (std) => `Not diveable under ${std} rules.`,
  ...
  disclaimer: 'Every dive carries risk. This app supports you, but it does not replace your own thinking and does not take over the responsibility for planning. Only dive what your training allows – if it doesn\'t feel right, don\'t dive!',
  dive: 'Dive',
  ...
  printDisclaimer: 'Every dive carries risk. This app supports you, but it does not replace your own thinking and does not take over the responsibility for planning. Only dive what your training allows – if it doesn\'t feel right, don\'t dive!',
  itinerary: 'Itinerary',
  itTime: 'Min',
  itDepth: (u) => `Depth (${u.d})`,
  itAction: 'Action',
