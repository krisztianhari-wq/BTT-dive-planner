...
const hu = {
  ...
  printDisclaimer: 'Nem validált terv, a merülés előtt független tervezővel ellenőrizd.',
  itinerary: 'Itiner',
  itTime: 'Perc',
...
const en: Dict = {
  ...
  printDisclaimer: 'Unvalidated plan, cross-check with an independent planner before diving.',
  itinerary: 'Itinerary',
  itTime: 'Min',
  itDepth: (u) => `Depth (${u.d})`,
  itAction: 'Action',
